...
pub const VERSION: RuntimeVersion = RuntimeVersion {
	spec_name: create_runtime_str!("guillotine-chain"),
	impl_name: create_runtime_str!("guillotine-chain"),
	authoring_version: 1,
...
impl_runtime_apis! {
	...
	impl sp_session::SessionKeys<Block> for Runtime {
		...
		fn decode_session_keys(encoded: Vec<u8>,) -> Option<Vec<(Vec<u8>, KeyTypeId)>> { opaque::SessionKeys::decode_into_raw_public_keys(&encoded) }
	}
